...
class AppointmentController extends VoyagerBaseController
{
    //***************************************
    //               ____
    //              |  _ \
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            //query to display appointment dokter only
            if (auth()->user()->hasRole('dokter')) {
                $query->whereHas('dokter', function ($query) {
                    $query->where('nama', auth()->id());
                });
            }
